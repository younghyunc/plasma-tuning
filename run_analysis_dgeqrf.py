...
def run_dgeqrf_analysis(A, m, n, nb, ib):

    logfile = "plasma_dgeqrf.json"
    ...
    for event_name in events:
        ...
        plasmalib.Plasma_DGEQRF_Profiling(\
                c_int(m),\
                c_int(n),\
...
def analysis_dgeqrf(plasmalib):
    ...
    for nb in range(32, 512+32, 32):
        for ib in range(32, nb+32, 32):
            run_dgeqrf_analysis(A, m, n, nb, ib)
